  ...
  return (
    <div>
      <Parallax pages={4.5} ref={ref}>
        ...
        >
        <h2 class={isMobile? "m100" : ""}> o frumoasa</h2>
        <h2 class={isMobile? "m200" : "m100"}>si desteapta</h2>
        <h2 class={isMobile? "m200" : "m300"}>si niste solduri pfai</h2>
        <h2 class={isMobile? "m1100" : "m300"}>O primavara minunata xoxo</h2>
        {isMobile? <h2 class="m100">P.S. Vezi ca tot asta primesti si de ziua ta</h2> : <></>}
        </ParallaxLayer>
      </Parallax>
    </div>
  );
